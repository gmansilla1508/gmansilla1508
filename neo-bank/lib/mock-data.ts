...
export const mockAccounts: Account[] = [
  ...
  },
  {
    ...
    balance: 980.00,
    flag: '💵',
    walletAddress: '0x1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f',
...
// Total net worth in USD: $4250.80 + $1988.24 + $980 + $1356.96 = $8576
...
export const mockTransactions: Transaction[] = [
  ...
  // Transfers
  { id: 'tx-3', amount: 250.00, type: 'credit', category: 'Transfer', description: 'Received from Sarah Miller', merchant: 'Sarah Miller', icon: '↩️', currency: 'USD', created_at: '2026-03-19T11:30:00Z' },
  { id: 'tx-4', amount: -150.00, type: 'debit', category: 'Transfer', description: 'Sent to James Wilson', merchant: 'James Wilson', icon: '↗️', currency: 'USD', created_at: '2026-03-18T16:00:00Z' },
  // Subscriptions
...
export const mockContacts = [
  { id: 'c-1', name: 'Sarah Miller', avatar: 'SM', handle: '@sarah', type: 'Awake User' },
  { id: 'c-2', name: 'James Wilson', avatar: 'JW', handle: '@james', type: 'Awake User' },
  { id: 'c-3', name: 'Emma Davis', avatar: 'ED', handle: '@emma', type: 'Awake User' },
  { id: 'c-4', name: 'Ryan Chen', avatar: 'RC', handle: '@ryan', type: 'Awake User' },
]
...
export const mockCards: Card[] = [
  ...
  },
  {
    ...
    network: 'Mastercard',
    spending_source: 'USDC',
    atm_limit: 300,
    monthly_spending: 320.00,
    monthly_limit: 2000,
    cross_border: true,
  },
]
...
export const mockInsights = {
  incomeTotal: 4500.00,
  incomeSources: [
    { label: 'Freelance payments (Upwork)', amount: 3400, percentage: 76 },
    { label: 'Consulting (Deel)', amount: 1100, percentage: 24 },
  ],
  stabilityScore: 'High' as const,
  stabilityMonths: 6,
  topCategories: [
    { label: 'Housing', amount: 1070, icon: '🏠', color: 'bg-violet-500', percentage: 58 },
    { label: 'Travel', amount: 365, icon: '✈️', color: 'bg-blue-500', percentage: 20 },
    { label: 'Subscriptions', amount: 37.97, icon: '📺', color: 'bg-pink-500', percentage: 11 },
    { label: 'Food & Drink', amount: 73, icon: '🛒', color: 'bg-amber-500', percentage: 4 },
    { label: 'Other', amount: 127, icon: '📦', color: 'bg-white/20', percentage: 7 },
  ],
  spentTotal: 1830.00,
  savedTotal: 2370.00,
